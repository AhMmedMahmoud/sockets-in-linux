...
namespace POSIXNetworkSocketLib
{
    ...
    public:
        ...
        /// @remark The function call is thread-safe.
        bool TryAddSender(NetworkSocket *communicator, std::function<void()> callback);
        ...
        /// @returns True if the communicator is added successfully to the poller; otherwise false
        /// @remark The function call is thread-safe.
        bool TryAddReceiver(NetworkSocket *communicator, std::function<void()> callback);
